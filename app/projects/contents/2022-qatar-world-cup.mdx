...
**Purpose:** Estimate match outcomes for the 2022 Qatar World Cup and simulate the tournament bracket using historical results and FIFA ranking data.

**My role:** Built the data preparation, feature engineering, model comparison, tournament simulation, and result visualization in a Jupyter Notebook.
