...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[var(--background)]">
      <div className="page-shell border-t border-[var(--divider)] py-6">
        <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
          ...
          <div className="flex items-center gap-5">
            <a aria-label="GitHub" target="_blank" href="https://github.com/jfloww" rel="noopener noreferrer" className="footer-icon">
              <Image src="/icons/github.svg" width={19} height={19} alt="" className="invert dark:invert-0" />
            </a>
            <a aria-label="LinkedIn" target="_blank" href="https://www.linkedin.com/in/jfloww/" rel="noopener noreferrer" className="footer-icon">
              <Image src="/icons/linkedin.svg" width={19} height={19} alt="" className="invert dark:invert-0" />
            </a>
            <a
            ...
            >
              <Image src="/icons/insta.svg" width={19} height={19} alt="" className="invert dark:invert-0" />
            </a>
